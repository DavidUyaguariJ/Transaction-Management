...
-- ÍNDICES
-- =============================================
CREATE UNIQUE NONCLUSTERED INDEX idx_transactions_external_reference_unique
    ON transactions(external_reference)
    WHERE external_reference IS NOT NULL;

CREATE
NONCLUSTERED INDEX idx_transactions_account_date
    ON transactions(account_id, created_at DESC);

CREATE
NONCLUSTERED INDEX idx_transactions_account_type_date
    ON transactions(account_id, type, created_at DESC);

CREATE
NONCLUSTERED INDEX idx_accounts_customer
    ON accounts(customer_id);

CREATE UNIQUE
NONCLUSTERED INDEX idx_accounts_number
